...
G_DEFINE_TYPE (GstV4l2MmngrBufferPool, gst_v4l2_mmngr_buffer_pool, GST_TYPE_V4L2_BUFFER_POOL);
#endif
...
static void
gst_v4l2_mmngr_buffer_pool_release_buffer (GstBufferPool * bpool, GstBuffer * buffer)
{
...
static GstFlowReturn
gst_v4l2_mmngr_buffer_pool_alloc_buffer (GstBufferPool * bpool, GstBuffer ** buffer,
    GstBufferPoolAcquireParams * params)
{
  GstFlowReturn ret;
  GstV4l2MemoryGroup *group = NULL;
...
static GstFlowReturn
gst_v4l2_mmngr_buffer_pool_acquire_buffer (GstBufferPool * bpool, GstBuffer ** buffer,
    GstBufferPoolAcquireParams * params)
{
  GstV4l2MmngrBufferPool *mpool = GST_V4L2_MMNGR_BUFFER_POOL (bpool);
  GstFlowReturn ret = GST_FLOW_OK;
